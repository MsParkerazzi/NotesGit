...
<html lang="en">
  ...
  <body>
      ...
      <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
          ...
          <div class="container-fluid">
              ...
              <div class="navbar-header">
                  ...
                  <a class="navbar-brand">NERDOEnotes</a>
        ...
        <div class="modal" id="loginModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn green pull-left" data-dismiss="modal" data-target="signupModal" data-toggle="modal">
                  Register
                </button>  
              </div>
          </div>
    ...
    <!-- Footer-->
      <div class="footer">
          <div class="container">
              <p>NERDOEnotes &copy; <?php $today = date("Y"); echo $today?></p>
          </div>
      </div>
